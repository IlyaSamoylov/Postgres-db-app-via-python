"""
Сессионный проект, Самойлов Илья Антонович, М25-555

Вариант 13

Описание предметной области:

Описание коллекций и экспонатов музея. Включает в себя: выставочные залы, коллекции, экспонаты, стоимости билетов.
Выставочные залы описываются названием. Коллекции состоят из: названия, краткого описания, списка выставочных залов,
в которых они размещены, периода показа, определяющегося датой начала и конца. Экспонаты состоят из: названия, краткого описания,
страховой стоимости, века создания, указания коллекции, в которую экспонат входит, указания зала, в котором он размещён, габаритных размеров,
 включающих высоту, ширину, длину, и условий содержания, определяемых необходимостью контроля температуры, необходимостью контроля влажности,
защищённостью от людей.
Стоимости билетов состоят из: типа посетителя, набора коллекций, к которым по данному билету возможен доступ, стоимости в рублях.

В сессионном проекте использовались:
